...
public class JLife : MonoBehaviour
{
    ...
    public void setInitialColor( int _colorPid )
    {
        if ( _colorPid > 0 )
        {
            this.transform.Find("Mesh_Pike").GetComponent<SkinnedMeshRenderer>().material.color = pColors[_colorPid];
        }        
    }
    ...
    public void suddenModelHalt( int _postMode )
    {
        if ( ! ZCode.WideLook )        
        {
            ...
            {
                if (_wid == 1 && _postMode == 4 && (_isTakingArrowDamage == 0))
                {
                    _postMode = 3;// The Pike is Shielding When Not under Arrow Fire
                }
    ...
    private bool isInsideSelectionColor = false;
    ...
    public void ManageSelectionRings()
    {
        ...
        {
            RoundRings.SetActive(true);
            if (!isInsideSelectionColor)
            {
                this.transform.Find("Mesh_Pike").GetComponent<SkinnedMeshRenderer>().material.color = selectionHighlightColor;
                isInsideSelectionColor = true;
            }            
        }
        else
        {
